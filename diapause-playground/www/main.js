...
//   pkg/     wasm-pack --target web output of diapause-playground
...
`,
  },
  {
    ...
    code: `#[diapause::coroutine(yield = u32, resume = u32)]
...
`,
  },
  {
    ...
    code: `#[diapause::coroutine(yield = u32, resume = bool)]
fn until_stop() -> u32 {
    let mut count: u32 = 0;
    loop {
...
async function loadTransform() {
  try {
    const module = await import("./pkg/diapause_playground.js");
    await module.default();
    return module.transform;
  } catch (err) {
    console.error(err);
    showStatus(
      "Failed to load the wasm module (pkg/diapause_playground.js). " +
