...
#   pkg/diapause_playground.js        wasm-bindgen glue (wasm-pack --target web)
#   pkg/diapause_playground_bg.wasm   the compiled transform
set -euo pipefail
...
mkdir -p dist/pkg
cp -R www/. dist/
cp pkg/diapause_playground.js pkg/diapause_playground_bg.wasm dist/pkg/
