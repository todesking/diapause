...
use diapause_macro_core::expand_debug;
...
fn loop_body_with_opaque_break() {
    ...
    b3 [label="b3 (resume)\li += 1;\lif i > 3 { __diapause_jump!(0); }\l", peripheries=2];
    b0 -> b1;
    b1 -> b3 [label="resume"];
    b3 -> b1;
...
"#
    ...
    b3 [label="b3 [S1] (resume)\li += 1;\lif i > 3 { __diapause_jump!(0); }\l", peripheries=2];
    b0 -> b1;
    b1 -> b3 [label="resume"];
    b3 -> b1;
    b3 -> b2 [label="jump", style=dashed];
...
fn tail_loop_with_completing_break() {
    ...
    b2 [label="b2 [S1] (resume)\lif f() { __diapause_jump!(0, 42); }\l", peripheries=2];
...
fn yield_all_body() {
    ...
    b1 [label="b1 (resume)\llet mut __dg0 = sub;\lmatch ::diapause::Coroutine::start(&mut __dg0)\l", peripheries=2];
    b2 [label="b2\lreturn ()\l"];
    b3 [label="b3\l{}\l"];
    b4 [label="b4\lyield __y0\l"];
    b5 [label="b5 (resume)\l", peripheries=2];
    b6 [label="b6\lmatch ::diapause::Coroutine::resume(&mut __dg0, __rv0)\l"];
    b7 [label="b7\l"];
    b8 [label="b8\l"];
    b9 [label="b9\l"];
    b10 [label="b10\l"];
    ...
    b0 -> b1 [label="resume"];
    b1 -> b3 [label="::diapause::CoroutineState::Complete(_)"];
    b1 -> b4 [label="::diapause::CoroutineState::Yielded(__y0)"];
    b3 -> b2;
    b4 -> b5 [label="resume __rv0"];
    b5 -> b6;
    b6 -> b9 [label="::diapause::CoroutineState::Complete(_)"];
    b6 -> b11 [label="::diapause::CoroutineState::Yielded(__y0)"];
    b7 -> b2;
    b8 -> b6;
    b9 -> b7;
    b10 -> b8;
...
"#
    ...
    b1 [label="b1 [S1] (resume)\llet mut __dg0 = sub;\lmatch ::diapause::Coroutine::start(&mut __dg0)\l", peripheries=2];
    ...
    b6 [label="b6 [B1]\lmatch ::diapause::Coroutine::resume(&mut __dg0, __rv0)\l"];
    ...
    b4 -> b5 [label="resume __rv0"];
    b5 -> b6;
    b6 -> b7 [label="::diapause::CoroutineState::Complete(_)"];
    b6 -> b8 [label="::diapause::CoroutineState::Yielded(__y0)"];
    b7 -> b2;
